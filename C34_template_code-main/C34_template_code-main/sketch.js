...
function preload()
{
  ...
  graystarImg=loadImage('g_star1.png')
...
function setup() 
{
  ...
  star=createSprite(130,300,50,50);
  star.scale=0.03
  star.addImage(starImg)

  star2=createSprite(400,300,50,50);
  star2.scale=0.03
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star)==true)
   {
    ...
    graystar=createSprite(35,50)
    graystar.scale=0.1
    graystar.addImage(graystarImg)
   }

   if(collide(fruit,star2)==true)
   {
    star2.visible=false
    graystar=createSprite(120,50)
    graystar.scale=0.1
    graystar.addImage(graystarImg)
   }
